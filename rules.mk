...
CONTAINER_BUILDSTAMPS := $(foreach BINARY,$(CONTAINER_BINARIES),build/$(BUILDSTAMP_NAME)-container)
...
artifacts/images/$(BINARY)-$(ARCH)-dockerfile: artifacts/images/Dockerfile.$(BINARY)
	...
	@sed					\
	    ...
	    $$< > $$@
build/$(BUILDSTAMP_NAME)-container: artifacts/images/$(BINARY)-$(ARCH)-dockerfile
endef
...
build/$(BUILDSTAMP_NAME)-container: bin/$(ARCH)/$(BINARY)
	@echo "container: bin/$(ARCH)/$(BINARY) ($(CONTAINER_NAME))"
	@echo "docker build					\
		$(DOCKER_BUILD_FLAGS)			\
		-t $(CONTAINER_NAME):$(VERSION)		\
		-f artifacts/images/$(BINARY)-$(ARCH)-dockerfile .	\
		$(VERBOSE_OUTPUT)"
	@docker build					\
		$(DOCKER_BUILD_FLAGS)			\
		-t $(CONTAINER_NAME):$(VERSION)		\
	...
	@echo @docker images -q $(CONTAINER_NAME):$(VERSION) >> $$@
endef
...
images-containers:
	@echo in images-containers
	# @$(MAKE) -C images containers
	@echo done with images-containers
...
container-clean:
	rm -f build/*-container artifacts/images/*-dockerfile .*-push
